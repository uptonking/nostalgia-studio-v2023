import { type WritableAtom } from '../atom/index';
import { type AllPaths, type BaseDeepMap, type FromPath } from './path';

export { AllPaths, FromPath, BaseDeepMap, getPath, setPath } from './path';
