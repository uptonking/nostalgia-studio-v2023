import { onMount, on } from '../lifecycle/index';
import { doAction } from '../action/index';
import { clean } from '../clean-stores/index';
...
export function mapTemplate(init) {
  warn(
    'Replace mapTemplate() to function with map() call inside and own cache',
  );
