...
export const replaceParentNodeOfType =
  (nodeType: NodeType | NodeType[], content: PMNode | Fragment) =>
  (tr: Transaction) => {
...
export const replaceSelectedNode =
  (content: PMNode | Fragment) => (tr: Transaction) => {
...
export const safeInsert =
  (content: PMNode | Fragment, position?: number, tryToReplace?: boolean) =>
  (tr: Transaction) => {
