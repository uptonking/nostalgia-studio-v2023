...
describe('React editor component', () => {
  ...
  it('basic editor in class component', async () => {
    ...
    const editorContainerElem = await waitFor(() =>
      getByTestId('editor-container'),
    );

    const toolbar = editorContainerElem.querySelectorAll(
      'div[data-w-e-toolbar]',
    )[0];
    expect(toolbar).toBeTruthy();
    const editor = editorContainerElem.querySelectorAll(
