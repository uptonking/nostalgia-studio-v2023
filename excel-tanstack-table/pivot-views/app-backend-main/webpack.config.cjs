...
const createEnvironmentHash = require('./tools/createEnvironmentHash.cjs');
const getClientEnvironment = require('./tools/env.cjs');
const paths = require('./tools/paths.cjs');
