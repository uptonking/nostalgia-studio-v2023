...
import { type Cart, type Drawing } from '@datalking/pivot-app-shared-lib';
import {
  Add,
  Delete,
  DeleteForever,
              ...
              <Table size='small'>
                <TableHead sx={{ backgroundColor: 'background.paper' }}>
                  <TableRow>
                    ...
                    <TableCell sx={{ textAlign: 'center', width: '14rem' }}>
                      Quantity
                    </TableCell>
                    ...
                    <TableRow key={item.cartId}>
                      <TableCell sx={{ display: 'flex', alignItems: 'center' }}>
                        <Box>
                          <img
                            src={
                              item.drawing?.thumbnail ?? item.product?.imageUrl
                            }
                      ...
                      <TableCell>
                        {formatted(
                          item.quantity *
                            (item.drawing?.price ?? item.product?.amount ?? 0),
                        )}
                      </TableCell>
                      <TableCell>
                        <IconButton
