...
export const routes: Readonly<AppRoute>[] = [
  ...
  },
  {
    title: 'Login',
    path: Paths.Login,
    component: React.lazy(() => import('../features/profile/Login')) as any,
    profile: true,
    anon: true,
    // connect `title` and `dialog`, nothing to do with `components`
    dialog: 'onboard',
  },
  {
    title: 'Register',
    path: '/register',
    component: React.lazy(() => import('../features/profile/Register')) as any,
    profile: true,
    anon: true,
...
export const getCurrentRoute = () =>
  routes.find((r) => r.path === window.location.pathname);
