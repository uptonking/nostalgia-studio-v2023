...
export type PaymentSource =
  (typeof PaymentSources)[keyof typeof PaymentSources];
...
export interface Setting<
  T = SystemSettings | GoogleSettings | Auth0Settings | InternalSettings,
> {
  name: SettingType;
  data: T;
}
export type SettingDataType = SystemSettings &
  GoogleSettings &
  Auth0Settings &
  InternalSettings;
