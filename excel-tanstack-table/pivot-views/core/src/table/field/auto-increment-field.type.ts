...
const autoIncrementTypeObjectSchema = z.object({
  [FIELD_TYPE_KEY]: autoIncrementTypeSchema,
});

export const createAutoIncrementFieldSchema = createBaseFieldSchema.merge(
  autoIncrementTypeObjectSchema,
);
export type ICreateAutoIncrementFieldInput = z.infer<
  typeof createAutoIncrementFieldSchema
>;

export const updateAutoIncrementFieldSchema = updateBaseFieldSchema.merge(
  autoIncrementTypeObjectSchema,
);
export type IUpdateAutoIncrementFieldInput = z.infer<
  typeof updateAutoIncrementFieldSchema
>;

export const autoIncrementFieldQuerySchema = baseFieldQuerySchema.merge(
  autoIncrementTypeObjectSchema,
);
export type IAutoIncrementFieldQuerySchema = z.infer<
  typeof autoIncrementFieldQuerySchema
>;
...
export type ICreateAutoIncrementFieldValue = z.infer<
  typeof createAutoIncrementFieldValue
>;
...
export type ICreateAutoIncrementFieldValue_internal = z.infer<
  typeof createAutoIncrementFieldValue_internal
>;
