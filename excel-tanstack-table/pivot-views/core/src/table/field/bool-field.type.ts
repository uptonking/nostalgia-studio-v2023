...
export const createBoolFieldSchema =
  createBaseFieldSchema.merge(boolTypeObjectSchema);
export type ICreateBoolFieldInput = z.infer<typeof createBoolFieldSchema>;

export const updateBoolFieldSchema =
  updateBaseFieldSchema.merge(boolTypeObjectSchema);
export type IUpdateBoolFieldInput = z.infer<typeof updateBoolFieldSchema>;

export const boolFieldQuerySchema =
  baseFieldQuerySchema.merge(boolTypeObjectSchema);
...
export type ICreateBoolFieldValue_internal = z.infer<
  typeof createBoolFieldValue_internal
>;
