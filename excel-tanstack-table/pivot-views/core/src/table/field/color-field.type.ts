...
export const createColorFieldSchema = createBaseFieldSchema.merge(
  colorTypeObjectSchema,
);
export type ICreateColorFieldInput = z.infer<typeof createColorFieldSchema>;

export const updateColorFieldSchema = updateBaseFieldSchema.merge(
  colorTypeObjectSchema,
);
export type IUpdateColorFieldInput = z.infer<typeof updateColorFieldSchema>;

export const colorFieldQuerySchema = baseFieldQuerySchema.merge(
  colorTypeObjectSchema,
);
...
export type ICreateColorFieldValue_internal = z.infer<
  typeof createColorFieldValue_internal
>;
