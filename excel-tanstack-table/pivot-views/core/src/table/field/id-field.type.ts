...
export const createIdFieldSchema =
  createBaseFieldSchema.merge(idTypeObjectSchema);
export type ICreateIdFieldInput = z.infer<typeof createIdFieldSchema>;

export const updateIdFieldSchema =
  updateBaseFieldSchema.merge(idTypeObjectSchema);
export type IUpdateIdFieldInput = z.infer<typeof updateIdFieldSchema>;

export const idFieldQuerySchema =
  baseFieldQuerySchema.merge(idTypeObjectSchema);
...
export type ICreateIdFieldValue_internal = z.infer<
  typeof createIdFieldValue_internal
>;
