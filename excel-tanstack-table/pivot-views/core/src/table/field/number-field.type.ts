...
export const createNumberFieldSchema = createBaseFieldSchema.merge(
  numberTypeObjectSchema,
);
export type ICreateNumberFieldInput = z.infer<typeof createNumberFieldSchema>;

export const updateNumberFieldSchema = updateBaseFieldSchema.merge(
  numberTypeObjectSchema,
);
export type IUpdateNumberFieldInput = z.infer<typeof updateNumberFieldSchema>;

export const numberFieldQuerySchema = baseFieldQuerySchema.merge(
  numberTypeObjectSchema,
);
...
export type ICreateNumberFieldValue_internal = z.infer<
  typeof createNumberFieldValue_internal
>;
