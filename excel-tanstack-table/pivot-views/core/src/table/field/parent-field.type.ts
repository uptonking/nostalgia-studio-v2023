...
export const createParentFieldSchema = createBaseFieldSchema
...
export const updateParentFieldSchema = updateBaseFieldSchema
  .merge(parentTypeObjectSchema)
  .merge(
    z.object({
      displayFieldIds: fieldIdSchema.array().optional(),
...
export type ICreateParentFieldValue_internal = z.infer<
  typeof createParentFieldValue_internal
>;
