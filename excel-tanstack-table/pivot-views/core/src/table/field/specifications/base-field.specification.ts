...
export abstract class BaseFieldSpecification<
  F extends Field,
> extends CompositeSpecification<Table, ITableSpecVisitor> {
  constructor(public readonly field: F) {
    super();
  }
}

export class WithFieldName extends CompositeSpecification<
  Table,
  ITableSpecVisitor
> {
  constructor(
...
export class WithFieldDescription extends CompositeSpecification<
  Table,
  ITableSpecVisitor
> {
  constructor(
...
export class WithFieldDisplay extends CompositeSpecification<
  Table,
  ITableSpecVisitor
> {
  constructor(
