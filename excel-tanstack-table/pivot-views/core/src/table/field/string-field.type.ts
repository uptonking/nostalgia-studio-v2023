...
export const createStringFieldSchema = createBaseFieldSchema.merge(
  stringTypeObjectSchema,
);
export type ICreateStringFieldInput = z.infer<typeof createStringFieldSchema>;

export const updateStringFieldSchema = updateBaseFieldSchema.merge(
  stringTypeObjectSchema,
);
export type IUpdateStringFieldInput = z.infer<typeof updateStringFieldSchema>;

export const stringFieldQuerySchema = baseFieldQuerySchema.merge(
  stringTypeObjectSchema,
);
...
export type ICreateStringFieldValue_internal = z.infer<
  typeof createStringFieldValue_internal
>;
