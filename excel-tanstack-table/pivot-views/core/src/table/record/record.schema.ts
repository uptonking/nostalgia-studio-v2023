...
export type RecordAllValueType =
  | ValueOf<RecordAllValues>
  | ValueOf<IInternalRecordValues>
...
export type IMutateRecordValueSchema = z.infer<
  ReturnType<typeof createMutateRecordValuesSchema>
>;
