...
export type IGetParentAvailableRecordQuery = z.infer<
  typeof getParentAvailableRecordsQueryInput
>;
export type IGetParentAvailableRecordsOutput = z.infer<
  typeof getParentAvailableRecordsQueryOutput
>;
