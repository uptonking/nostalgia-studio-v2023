...
export type IGetTreeAvailableRecordsQuery = z.infer<
  typeof getTreeAvailableRecordsQueryInput
>;
export type IGetTreeAvailableRecordsOutput = z.infer<
  typeof getTreeAvailableRecordsQueryOutput
>;
