  ...
  resources: {
    en: {
      ...
      auth: {
        login: 'Login',
        logout: 'Logout',
        'login to watarble': 'Login to watarble',
        'register to watarble': 'Register to watarble',
        register: 'Register',
        email: 'Email address',
      ...
      table: {
        'shortcut T':
          'Use shortcut {{ shortcut }} to create table from anywhere.',
    ...
    'zh-CN': {
      ...
      auth: {
        ...
        'has account': '已有账号？',
        'login to watarble': '登录',
        'register to watarble': '注册账号',
      },
      common: {
        error: '发生错误',
        Apply: '应用',
