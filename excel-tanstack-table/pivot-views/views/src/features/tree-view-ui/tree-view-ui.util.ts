...
export function cloneFlattened(
  item: FlattenedSortableRecord,
): FlattenedSortableRecord {
  return {
    ...cloneItem(item),
    depth: item.depth,
...
function getMaxDepth({
  ...
  previousItem: FlattenedSortableRecord;
}) {
  if (previousItem) {
...
export function buildTree(
  flattenedItems: FlattenedSortableRecord[],
): SortableRecordItems {
  const root: SortableRecordItem = {
    id: 'root',
    values: {} as RecordAllValues,
    children: [],
  };
