...
import { useUpdateTableMutation } from '@datalking/pivot-store';
import {
  ActionIcon,
  Alert,
  Box,
...
export const UpdateTableForm: React.FC<IProps> = ({
  onCancel,
  onSuccess: success,
}) => {
  ...
  const [updateTable, { reset: resetUpdateTable, isLoading, isError, error }] =
