...
// const SelectCalendarFieldModal = loadable(
//   () => import('./features/calendar-ui/select-calendar-field-modal'),
// );
// const CreateFieldModal = loadable(
//   () => import('./features/create-field-form/create-field-modal'),
// );
// const CreateOptionModal = loadable(
//   () => import('./features/create-option-form/create-option-form-modal'),
// );
// const SelectKanbanFieldModal = loadable(
//   () => import('./features/kanban-ui/select-kanban-field-modal'),
// );
// const SelectTreeViewFieldModal = loadable(
//   () => import('./features/tree-view-ui/select-tree-view-field-modal'),
// );
// const UpdateFieldModal = loadable(
//   () => import('./features/update-field-form/update-field-modal'),
// );
// const UpdateOptionModal = loadable(
//   () => import('./features/update-option-form/update-option-modal'),
// );
// const CreateViewModal = loadable(
//   () => import('./features/view/create-view-modal'),
// );
...
export const CREATE_OPTION_MODAL_ID = 'CREATE_OPTION';
...
export const SELECT_TREE_VIEW_FIELD_MODAL_ID =
