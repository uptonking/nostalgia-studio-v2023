...
export interface ExpandedOptions<TData extends RowData> {
  /** if true, getExpandedRowModel will not be used to expand rows and you would
   *   be expected to perform the expansion in your own data model.
   ...
   *   (which means expanded rows may span multiple pages).
