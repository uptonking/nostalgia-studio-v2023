...
export const ProseMirrorEditor = forwardRef<Handle, Props>(
  function ProseMirror(props, ref): JSX.Element {
    ...
    return (
      <div ref={rootRef} style={props.style} className={props.className} />
    );
  },
);
