...
import ItemTags from '../../../layouts/sidebar/ItemTags';
import SidebarSpecialNoncollapsibleItem from '../../../layouts/sidebar/SidebarSpecialNoncollapsibleItem';
...
/**
 * 单个mini-app资料小程序的侧边栏组件；
 * 最多支持3级菜单，直接使用ul/li实现，没有使用复杂组件和递归算法；
 * todo mini-sidebar显示首字母或首字符。
 */
export function MiniAppSidebar(props: SidebarProps) {
  ...
  const memoedResultJsx = useMemo(
    () => (
      <aside
        id='sidebarbg'
        className='left-sidebar mini-app-sidebar'
        ...
        <div className='scroll-sidebar'>
          <PerfectScrollbar className='sidebar-nav'>
            <div className='sidebar-nav'>
              <Nav id='sidebarnav' className='mini-app-sidebar'>
                {routes
                  .filter((r) => r.path !== '/')
                  .map((route1: any, key) => {
