...
/** 此div会作为prosemirror editor最直接的父元素，
 * 这里设置了整个编辑器所有css，包括各种组件的基本样式
 */
// prettier-ignore
export const StyledEditor = styled('div')<{
  ...
  h6 {
    ...
    &:not(.placeholder):before {
      ...
      line-height: 0;
      /* margin-left: -24px; */
      ${props=>props.rtl?'margin-right: -24px;':'margin-left: -24px;'}
      width: 24px;
    }
  ...
  .with-emoji {
    /* margin-left: -1em; */
    ${props=>props.rtl?'margin-right: -1em;':'margin-left: -1em;'}
  }
  ...
  .notice-block .icon {
    ...
    /* margin-right: 4px; */
    ${props=>props.rtl?'margin-left: 4px;':'margin-right: 4px;'}
  ...
  blockquote {
    ...
    &:before {
      ...
      position: absolute;
      /* margin-left: -16px; */
    ${props=>props.rtl?'margin-right: -16px;':'margin-left: -16px;'}
      top: 0;
      bottom: 0;
  ...
  ol {
    ...
    ol {
      /* margin-right: -24px; */
    ${props=>props.rtl?'margin-left: -24px;':'margin-right: -24px;'}
  ...
  ul.checkbox_list li {
    display: flex;
    /* padding-left: 24px; */
    ${props=>props.rtl?'padding-right: 24px;':'padding-left: 24px;'}
  ...
  ol li::before {
    ...
    position: absolute;
    /* left: -40px; */
    ${props=>props.rtl?'right: -40px;':'left: -40px;'}
    ...
    * {
    ...
    .grip-column {
      ...
      &.first::after {
        ...
        ${props=>props.rtl?'border-top-right-radius: 3px;':'border-top-left-radius: 3px;'}

      }
      &.last::after {
        /* border-top-right-radius: 3px; */
        ${props=>props.rtl?'border-top-left-radius: 3px;':'border-top-right-radius: 3px;'}
    ...
    .grip-row {
      &::after {
        ...
        ${props=>props.rtl?'border-left:3px solid;':'border-right:3px solid;'}
      ...
      &.last::after {
        ...
        ${props=>props.rtl?'border-bottom-right-radius: 3px;':'border-bottom-left-radius: 3px;'}
      }
      &.selected::after {
        background: ${(props) => props.theme.tableSelected};
      }
    ...
    .grip-table {
      &::after {
        ...
        top: -18px;
        /* left: -18px; */
        ${props=>props.rtl?'right:-18px;':'left:-18px;'}
        display: ${(props) => (props.readOnly ? 'none' : 'block')};
      }
  ...
  .scrollable {
    ...
    ${props=>props.rtl?'padding-right:1em;':'padding-left:1em;'}
    ${props=>props.rtl?'margin-right:-1em;':'margin-left:-1em;'}
    ${props=>props.rtl?'border-right:1px solid transparent;':'border-left:1px solid transparent;'}
    ${props=>props.rtl?'border-left:1px solid transparent;':'border-right:1px solid transparent;'}
  ...
  .scrollable-shadow {
    ...
    bottom: 0;
    /* left: -1em; */
    ${props=>props.rtl?'right:-1em;':'left:-1em;'}

    width: 16px;
    transition: box-shadow 250ms ease-in-out;
    border: 0px solid transparent;
    /* border-left-width: 1em; */
    ${props=>props.rtl?'border-right-width:1em;':'border-left-width:1em;'}
    pointer-events: none;
