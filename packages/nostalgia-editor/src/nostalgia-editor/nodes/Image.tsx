...
export default class Image extends Node {
      ...
      parseDOM: [
        {
          ...
          getAttrs: (dom: HTMLDivElement) => {
            ...
            console.log(';;img-parseDOM, ', img.getAttribute('alt'));
  ...
  toMarkdown(state, node) {
    console.log(';;img-toMarkdown, ', node);
  ...
  parseMarkdown() {
    return {
      node: 'image',
      getAttrs: (token) => {
        console.log(';;img-parseMarkdown, ', token);
