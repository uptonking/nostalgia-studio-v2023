...
// const OPEN_REGEX = /^\/(\w+)?$/;
const OPEN_REGEX = /^\/|\.|、(\w+)?$/;
/** 注意close规则与open规则紧密相关，匹配到close规则时，block-menu会关闭，定制时要改多处 */
  ...
  get plugins() {
    ...
    return [
      new Plugin({
        props: {
          handleClick: () => {
            // console.log(';;BlockMenuTrigger-handleClick');
          ...
          handleKeyDown: (view, event) => {
              ...
              setTimeout(() => {
                ...
                return run(view, pos, pos, OPEN_REGEX, (state, match) => {
                  if (match) {
                    ...
                    // console.log(';;BlockMenuTrigger-handleKeyDown-close');
                    this.options.onClose();
                  }
                  return null;
                });
            ...
            if (
              ...
              console.log(
                ';;BlockMenuTrigger-handleKeyDown - not to do anything',
              );
  ...
  inputRules() {
    return [
      ...
      new InputRule(CLOSE_REGEX, (state, match) => {
        if (match) {
          // console.log(';;BlockMenuTrigger-InputRule-CLOSE_REGEX');
          this.options.onClose();
        }
        return null;
      }),
