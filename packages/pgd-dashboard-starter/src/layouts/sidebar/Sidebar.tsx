...
export function Sidebar(props: SidebarProps) {
  // console.log(';;Sidebar-props, ', props)I;
  ...
  const toggleCollapseMenuHandlers = useMemo(() => {
    ...
    props.routes.forEach((route1, key) => {
      if (route1.routes && route1.routes.length && route1.name.trim()) {
        ...
        route1.routes.forEach((route2, key) => {
        ...
        <div className='scroll-sidebar'>
          <PerfectScrollbar className='sidebar-nav'>
            <div className='sidebar-nav'>
              <Nav id='sidebarnav'>
                {props.routes.map((route1: any, key) => {
                                ...
                                return (
                                  ...
                                  >
                                    <span
                                      ...
                                      onClick={
                                        toggleCollapseMenuHandlers[route2.path]
                                      }
                                    >
                                    ...
                                    <Collapse
                                      isOpen={openedMenuItems.has(route2.path)}
                                    >
