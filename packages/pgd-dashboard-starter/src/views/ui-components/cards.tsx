...
const Cards = () => {
  return (
    <div>
      <h3 className='mb-3'>Basic Cards</h3>
      <Row>
        <Col xs='12' md='4'>
          <Card>
      ...
      <h3 className='mb-3'>Cards Content Types</h3>
      <Row>
        <Col xs='12' md='4'>
          <Card>
            <CardBody>
      ...
      <h3 className='mb-3'>Cards Sizing</h3>
      <Row>
        <Col sm='6'>
          <Card body>
      ...
      <h3 className='mb-3'>Cards with Text alignment</h3>
      <Row>
        <Col xs='12' md='4'>
          <Card body>
            <CardTitle>Special Title Treatment</CardTitle>
      ...
      <h3 className='mb-3'>Cards with Header and Footer</h3>
      <Row>
        <Col sm='6'>
          <Card>
      ...
      <h3 className='mb-3'>Cards with Image Caption</h3>
      <Row>
        <Col sm='6'>
          <Card>
      ...
      <h3 className='mb-3'>Cards Image with Overlay </h3>
      <Row>
        <Col xs='12' md='6'>
          <Card inverse>
      ...
      <h3 className='mb-3'>Cards with Background Color</h3>
      <Row>
        <Col xs='12' md='4'>
          <Card
            body
      ...
      <h3 className='mb-3'>Cards with Borderline Color</h3>
      <Row>
        <Col xs='12' md='4'>
      ...
      <h3 className='mb-3'>Card Group</h3>
      <CardGroup>
        <Card>
          <CardImg top width='100%' src={img4} alt='Card image cap' />
          <CardBody>
      ...
      <h3 className='mb-3'>Card Deck</h3>
      <CardDeck>
        <Card>
      ...
      <h3 className='mb-3 mt-4'>Card Columns</h3>
      <CardColumns>
        <Card>
          <CardImg top width='100%' src={img1} alt='Card image cap' />
          <CardBody>
