...
export type CardWithMediaClientConfigProps =
  WithMediaClientConfigProps<CardWithAnalyticsEventsProps>;

type CardWithMediaClientConfigComponent =
  React.ComponentType<CardWithMediaClientConfigProps>;

type MediaCardErrorBoundaryComponent =
