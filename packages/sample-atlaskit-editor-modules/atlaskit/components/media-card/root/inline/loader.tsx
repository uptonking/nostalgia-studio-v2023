...
export type InlineMediaCardWithMediaClientConfigProps =
  WithMediaClientConfigProps<InlineMediaCardProps>;

type InlineMediaCardWithMediaClientConfigComponent =
  React.ComponentType<InlineMediaCardWithMediaClientConfigProps>;
