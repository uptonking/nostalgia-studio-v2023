...
const shouldForceTracking = false;

// #region /folded 计算FeatureFlags
/** 获取操作scrollbar-gutter的方法 */
  ...
  return {
    ...
    textFormatting: {
      ...
      responsiveToolbarMenu:
        // props.textFormatting?.responsiveToolbarMenuI
...
// #endregion /folded 计算FeatureFlags
