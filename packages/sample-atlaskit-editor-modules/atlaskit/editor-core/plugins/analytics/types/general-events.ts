import type { RichMediaLayout } from '../../../../adf-schema';
import type { SEVERITY } from '../../../../editor-common';
import type { FeatureFlagKey } from '../../../types/feature-flags';
import type { PluginPerformanceReportData } from '../../../utils/performance/plugin-performance-report';
import {
  ACTION,
  ACTION_SUBJECT,
  ACTION_SUBJECT_ID,
