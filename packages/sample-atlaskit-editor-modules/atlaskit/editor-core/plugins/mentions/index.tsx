...
import { mention } from '../../../adf-schema';
import { MentionItem } from '../../../components/mention/item';
import {
  ELEMENTS_CHANNEL,
  MentionDescription,
  MentionProvider,
...
} from '../../../components/mention/resource';
import {
  TeamMentionHighlight,
  TeamMentionHighlightController,
} from '../../../components/mention/spotlight';
import { TeamMember } from '../../../components/mention/team-resource';
import {
      ...
      typeAhead: {
        ...
        getItems(
          ...
          if (pluginState.mentionProvider && !!query && mentions.length <= 2) {
            const { inviteExperimentCohort, shouldEnableInvite, userRole } =
