...
export const ContextPanelReactCtx = React.createContext<ContextPanelContext>({
  width: 0,
...
/** 传递ContextPanelContext的value */
const Provider = ContextPanelReactCtx.Provider;
/** 获取ContextPanelContext的value */
const Consumer = ContextPanelReactCtx.Consumer;
export { Provider as ContextPanelProvider, Consumer as ContextPanelConsumer };

export const useContextPanelContext = () =>
  React.useContext(ContextPanelReactCtx);
