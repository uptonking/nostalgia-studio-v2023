...
export class ReactNodeView<P = ReactComponentProps> implements NodeView {
  ...
  init() {
    ...
    // 初始化时首次渲染ReactNodeView
    this.renderReactComponent(() =>
      this.render(this.reactComponentProps, this.handleRef),
    );

    console.log(';;NodeView.init()');

    return this;
  }

  /** 通过portal将react组件渲染为react元素，此时没有挂载到全局react tree */
  ...
  /** 执行此callbackRef方法时，会将contentDOM作为children添加到NodeViewReact组件 */
