...
export class AbstractSublevelIterator extends AbstractIterator {
...
export class AbstractSublevelKeyIterator extends AbstractKeyIterator {
  constructor(db, options, iterator, unfix) {
    super(db, options);
...
export class AbstractSublevelValueIterator extends AbstractValueIterator {
