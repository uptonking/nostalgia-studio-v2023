...
exports.range = function (test, testCommon) {
  ...
  function checkLength(arr, length) {
    if (arr.length !== length) {
      throw new RangeError(
        'Expected ' + length + ' elements, got ' + arr.length,
      );
    }
  ...
  rangeTest(
    'test iterator with gte=30 and lte=70 and gt=40 and lt=60',
    {
      gte: '30',
      lte: '70',
      gt: '40',
  ...
  rangeTest(
    'test iterator with gte=30 and lte=70 and gt=20 and lt=80',
    {
      gte: '30',
      lte: '70',
      gt: '20',
