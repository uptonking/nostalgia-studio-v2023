...
export class AbstractIterator<TDatabase, K, V> extends CommonIterator<
  TDatabase,
  [K, V]
> {
  ...
  seek<TTarget = K>(
    target: TTarget,
    options: AbstractSeekOptions<TTarget>,
  ): void;
}

export class AbstractKeyIterator<TDatabase, K> extends CommonIterator<
  TDatabase,
  K
> {
...
export class AbstractValueIterator<TDatabase, K, V> extends CommonIterator<
  TDatabase,
  V
> {
