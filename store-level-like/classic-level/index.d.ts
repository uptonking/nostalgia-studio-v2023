import {
  ...
  type AbstractGetOptions,
  type AbstractGetManyOptions,
  type AbstractPutOptions,
  type AbstractDelOptions,
  type AbstractBatchOperation,
  type AbstractBatchOptions,
  AbstractChainedBatch,
  type AbstractChainedBatchWriteOptions,
...
> extends AbstractLevel<string | Buffer | Uint8Array, KDefault, VDefault> {
  ...
  approximateSize<K = KDefault>(
    start: K,
    end: K,
    options: StartEndOptions<K>,
  ): Promise<number>;
  approximateSize<K = KDefault>(
    start: K,
    end: K,
...
export interface GetOptions<K, V>
  extends AbstractGetOptions<K, V>,
    ReadOptions {}

/**
 * Options for the {@link ClassicLevel.getMany} method.
 */
export interface GetManyOptions<K, V>
  extends AbstractGetManyOptions<K, V>,
    ReadOptions {}
 ...
 */
export interface PutOptions<K, V>
  extends AbstractPutOptions<K, V>,
    WriteOptions {}
 ...
 */
export interface BatchOptions<K, V>
  extends AbstractBatchOptions<K, V>,
    WriteOptions {}

/**
 * Options for the {@link ChainedBatch.write} method.
 */
export interface ChainedBatchWriteOptions
  extends AbstractChainedBatchWriteOptions,
    WriteOptions {}
...
export type BatchOperation<TDatabase, K, V> = AbstractBatchOperation<
  TDatabase,
  K,
  V
>;
...
export type ValueIterator<TDatabase, K, V> = AbstractValueIterator<
  TDatabase,
  K,
  V
>;
