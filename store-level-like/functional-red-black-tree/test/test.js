...
tape('foreach', function (t) {
  const u = iota(31).reduce(function (u, k, v) {
    return u.insert(k, v);
  }, makeTree());
...
tape('iterators', function (t) {
  const u = iota(20).reduce(function (u, k, v) {
    return u.insert(k, v);
  }, makeTree());
...
tape('remove()', function (t) {
  ...
  for (let n = 0; n < sz.length; ++n) {
    const c = sz[n];
    const u = iota(c).reduce(function (u, k, v) {
      return u.insert(k, v);
    }, makeTree());
    for (let i = 0; i < c; ++i) {
...
tape('update()', function (t) {
  ...
  const u = arr.reduce(function (u, k, v) {
    return u.insert(k, v);
  }, makeTree());
...
tape('keys and values', function (t) {
  ...
  const zipped = iota(6).map(function (i) {
  ...
  const keys = zipped.map(function (v) {
    return v[0];
  });
  const values = zipped.map(function (v) {
    return v[1];
  });
