...
export abstract class Encoding<TIn, TFormat, TOut>
  implements IEncoding<TIn, TFormat, TOut>
{
 ...
 */
export type KnownEncoding<N extends KnownEncodingName, TFormat> = Encoding<
  KnownEncodingInput<N>,
  TFormat,
  KnownEncodingOutput<N>
>;
