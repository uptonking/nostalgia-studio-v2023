...
> extends ReadableStream<{ key: K; value: V }> {
  /**
...
> extends ReadableStream<K> {
  ...
  constructor(
    db: TDatabase,
    options?:
      | (LevelReadableStreamOptions & AbstractKeyIteratorOptions<K>)
      | undefined,
  );
}
...
> extends ReadableStream<V> {
  ...
  constructor(
    db: TDatabase,
    options?:
      | (LevelReadableStreamOptions & AbstractValueIteratorOptions<K, V>)
      | undefined,
  );
}
