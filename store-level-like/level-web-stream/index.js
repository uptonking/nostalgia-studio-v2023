...
export class EntryStream extends LevelReadableStream {
  constructor(db, options) {
    super(db, 'iterator', { ...options, keys: true, values: true });
  }
}

export class KeyStream extends LevelReadableStream {
  constructor(db, options) {
    super(db, 'keys', options);
  }
}

export class ValueStream extends LevelReadableStream {
  constructor(db, options) {
...
class LevelSink {
  ...
  write(operation) {
    if (Array.isArray(operation)) {
      ...
      operation = { ...operation, type: this[kBatchType] };
    }
...
export class BatchStream extends WritableStream {
  constructor(db, options) {
