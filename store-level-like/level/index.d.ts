...
> {
  ...
  getMany(
    keys: KDefault[],
    callback: AbstractLevel.NodeCallback<VDefault[]>,
  ): void;
  ...
  ): Iterator<typeof this, K, V>;

  keys(): KeyIterator<typeof this, KDefault>;
  keys<K = KDefault>(
    options: KeyIteratorOptions<K>,
  ): KeyIterator<typeof this, K>;
...
export type DatabaseOptions<K, V> = ClassicLevel.DatabaseOptions<K, V> &
  BrowserLevel.DatabaseOptions<K, V>;
export type OpenOptions = ClassicLevel.OpenOptions & BrowserLevel.OpenOptions;
export type GetOptions<K, V> = ClassicLevel.GetOptions<K, V> &
  BrowserLevel.GetOptions<K, V>;
export type GetManyOptions<K, V> = ClassicLevel.GetManyOptions<K, V> &
  BrowserLevel.GetManyOptions<K, V>;
export type PutOptions<K, V> = ClassicLevel.PutOptions<K, V> &
  BrowserLevel.PutOptions<K, V>;
export type DelOptions<K> = ClassicLevel.DelOptions<K> &
  BrowserLevel.DelOptions<K>;

export type BatchOptions<K, V> = ClassicLevel.BatchOptions<K, V> &
  BrowserLevel.BatchOptions<K, V>;
export type BatchOperation<TDatabase, K, V> = ClassicLevel.BatchOperation<
  TDatabase,
  K,
  V
> &
  BrowserLevel.BatchOperation<TDatabase, K, V>;
export type ChainedBatch<TDatabase, K, V> = ClassicLevel.ChainedBatch<
  TDatabase,
  K,
  V
> &
...
export type Iterator<TDatabase, K, V> = ClassicLevel.Iterator<TDatabase, K, V> &
  BrowserLevel.Iterator<TDatabase, K, V>;
export type KeyIterator<TDatabase, K> = ClassicLevel.KeyIterator<TDatabase, K> &
  BrowserLevel.KeyIterator<TDatabase, K>;
export type ValueIterator<TDatabase, K, V> = ClassicLevel.ValueIterator<
  TDatabase,
  K,
  V
> &
...
export type IteratorOptions<K, V> = ClassicLevel.IteratorOptions<K, V> &
  BrowserLevel.IteratorOptions<K, V>;
export type KeyIteratorOptions<K> = ClassicLevel.KeyIteratorOptions<K> &
  BrowserLevel.KeyIteratorOptions<K>;
export type ValueIteratorOptions<K, V> = ClassicLevel.ValueIteratorOptions<
  K,
  V
> &
