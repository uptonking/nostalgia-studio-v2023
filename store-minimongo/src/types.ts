...
export interface MinimongoLocalCollection<T = any>
  extends MinimongoBaseCollection<T> {
  cache(
    docs: T[],
    selector: any,
    options: any,
...
export type MinimongoCollection<T = any> =
  | MinimongoBaseCollection<T>
  | MinimongoLocalCollection<T>;
