...
describe('Indexes', function () {
  describe('Insertion', function () {
    it('Can insert pointers to documents in the index correctly when they have the field', function () {
      ...
      const doc1 = { a: 5, _id: 'hello' };
      const doc2 = { a: 8, _id: 'world' };
      const doc3 = { a: 2, _id: 'bloup' };
      idx.insert(doc1);
      idx.insert(doc2);
      idx.insert(doc3);
    ...
    it('Works with dot notation', function () {
      ...
      const doc1 = { _id: 5, tf: { nested: 'hello' } };
      const doc2 = { _id: 8, tf: { nested: 'world', additional: true } };
      const doc3 = { _id: 2, tf: { nested: 'bloup', age: 42 } };
      idx.insert(doc1);
      idx.insert(doc2);
      idx.insert(doc3);
    ...
    it('Can insert an array of documents', function () {
      ...
      const doc1 = { _id: 5, tf: 'hello' };
      const doc2 = { _id: 8, tf: 'world' };
      const doc3 = { _id: 2, tf: 'bloup' };
    ...
    describe('Array fields', function () {
      it('Inserts one entry per array element in the index', function () {
        const obj = { tf: ['aa', 'bb'], really: 'yeah', _id: 1 };
        const obj2 = { tf: 'normal', yes: 'indeed', _id: 2 };
        const idx = new Index({ fieldName: 'tf' });
        idx.insert(obj);
      ...
      it('Inserts one entry per unique array element in the index, the unique constraint only holds across documents', function () {
        const obj = { tf: ['aa', 'aa'], really: 'yeah', _id: 1 };
        const obj2 = { tf: ['cc', 'yy', 'cc'], yes: 'indeed', _id: 2 };
        const idx = new Index({ fieldName: 'tf', unique: true });
        idx.insert(obj);
      ...
      it('The unique constraint holds across documents', function () {
        const obj = { tf: ['aa', 'aa'], really: 'yeah', _id: 1 };
        const obj2 = { tf: ['cc', 'aa', 'cc'], yes: 'indeed', _id: 2 };
        const idx = new Index({ fieldName: 'tf', unique: true });
        idx.insert(obj);
        idx.getAll().length.should.equal(1);
        idx.getAll()[0].should.equal(obj._id);
  ...
  describe('Removal', function () {
    it('Can remove pointers from the index, even when multiple documents have the same key', function () {
      ...
      const doc2 = { a: 8, tf: 'world', _id: 2 };
      const doc3 = { a: 2, tf: 'bloup', _id: 3 };
      const doc4 = { a: 23, tf: 'world', _id: 4 };
      idx.insert(doc1);
      idx.insert(doc2);
      idx.insert(doc3);
      idx.insert(doc4);
  ...
  describe('Update', function () {
    it('Can update a document whose key did or didnt change', function () {
      ...
      const doc2 = { _id: 8, tf: 'world' };
      const doc3 = { _id: 2, tf: 'bloup' };
      const doc4 = { _id: 23, tf: 'world' };
      const doc5 = { _id: 1, tf: 'changed' };
      idx.insert(doc1);
      idx.insert(doc2);
      idx.insert(doc3);
      idx.tree.getNumberOfKeys().should.equal(3);
    ...
    it('Can update an array of documents', function () {
      ...
      const doc2 = { _id: 8, tf: 'world' };
      const doc3 = { _id: 2, tf: 'bloup' };
      const doc1b = { _id: 23, tf: 'world' };
      const doc2b = { _id: 1, tf: 'changed' };
      const doc3b = { _id: 44, tf: 'bloup' };
      idx.insert(doc1);
      idx.insert(doc2);
      idx.insert(doc3);
      idx.tree.getNumberOfKeys().should.equal(3);
    ...
    it('If a unique constraint is violated during an array-update, all changes are rolled back and an error thrown', function () {
      const idx = new Index({ fieldName: 'tf', unique: true });
      const doc0 = { _id: 432, tf: 'notthistoo' };
      const doc1 = { _id: 5, tf: 'hello' };
      const doc2 = { _id: 8, tf: 'world' };
      const doc3 = { _id: 2, tf: 'bloup' };
      const doc1b = { _id: 23, tf: 'changed' };
      const doc2b = { _id: 1, tf: 'changed' }; // Will violate the constraint (first try)
      const doc2c = { _id: 1, tf: 'notthistoo' }; // Will violate the constraint (second try)
      const doc3b = { _id: 44, tf: 'alsochanged' };
      idx.insert(doc1);
      idx.insert(doc2);
      idx.insert(doc3);
      idx.tree.getNumberOfKeys().should.equal(3);
  ...
  describe('Get matching documents', function () {
    ...
    it('Can get all documents for which a field is undefined', function () {
      const idx = new Index({ fieldName: 'tf' });
      const doc1 = { _id: 5, tf: 'hello' };
      const doc2 = { _id: 2, nottf: 'bloup' };
      const doc3 = { _id: 8, tf: 'world' };
      const doc4 = { _id: 7, nottf: 'yes' };
      idx.insert(doc1);
      idx.insert(doc2);
      idx.insert(doc3);
    ...
    it('Can get all documents for which a field is null', function () {
      const idx = new Index({ fieldName: 'tf' });
      const doc1 = { _id: 5, tf: 'hello' };
      const doc2 = { _id: 2, tf: null };
      const doc3 = { _id: 8, tf: 'world' };
      const doc4 = { _id: 7, tf: null };
      idx.insert(doc1);
      idx.insert(doc2);
      idx.insert(doc3);
    ...
    it('Can get all documents whose key is in an array of keys', function () {
      const idx = new Index({ fieldName: 'tf' });
      const doc1 = { _id: 5, tf: 'hello' };
      const doc2 = { _id: 2, tf: 'bloup' };
      const doc3 = { _id: 8, tf: 'world' };
      const doc4 = { _id: 7, tf: 'yes' };
      const doc5 = { _id: 7, tf: 'yes' };
      idx.insert(doc1);
      idx.insert(doc2);
      idx.insert(doc3);
      idx.insert(doc4);
