 ...
 */
export const existsAsync = async (file) => {
  try {
 ...
 * @async
 */
export const renameAsync = async (oldPath, newPath) => {
  try {
 ...
 * @async
 */
export const writeFileAsync = async (file, data, options = {}) => {
 ...
 * @async
 */
export const appendFileAsync = async (filename, toAppend, options) => {
  // Options do not matter in browser setup
  try {
 ...
 * @async
 */
export const readFileAsync = async (filename, options) => {
  try {
 ...
 */
export const unlinkAsync = async (filename) => {
  try {
 ...
 * @async
 */
export const mkdirAsync = (path, options) => Promise.resolve();
 ...
 */
export const ensureDatafileIntegrityAsync = (filename) => Promise.resolve();
 ...
 */
export const crashSafeWriteFileLinesAsync = async (filename, lines) => {
  lines.push(''); // Add final new line
  await writeFileAsync(filename, lines.join('\n'));
};

/** never exec */
// export const readFileStream = (path, options) => { }
export const readFileStream = undefined;
