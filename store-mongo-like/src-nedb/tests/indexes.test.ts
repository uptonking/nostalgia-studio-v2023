...
describe('Indexes', function () {
  ...
  describe('Get matching documents', function () {
    ...
    it('Can get all documents whose key is in an array of keys', function () {
      ...
      assert.deepStrictEqual(idx.getMatching(['bloup', 'yes']), [
        doc2,
        doc4,
        doc5,
      ]);
    ...
    it('Can get all documents whose key is between certain bounds', function () {
      ...
      assert.deepStrictEqual(idx.getBetweenBounds({ $lt: 10, $gte: 5 }), [
        doc1,
        doc4,
        doc3,
      ]);
      assert.deepStrictEqual(idx.getBetweenBounds({ $lte: 8 }), [
        doc2,
        doc1,
        doc4,
        doc3,
  ...
  it('Get all elements in the index', function () {
    ...
    assert.deepStrictEqual(idx.getAll(), [
      { a: 2, tf: 'bloup' },
      { a: 5, tf: 'hello' },
      { a: 8, tf: 'world' },
    ]);
