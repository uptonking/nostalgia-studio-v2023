import { isDate, isRegExp, uniq } from './utils';
 ...
 */
export const compareThings = (a, b, _compareStrings = undefined) => {
...
const modifierFunctions = {
  ...
  $inc: createModifierFunction((obj, field, value) => {
    ...
    if (typeof obj[field] !== 'number') {
      if (!Object.hasOwn(obj, field)) obj[field] = value;
  ...
  if (Array.isArray(objValue) && !treatObjAsValue) {
    ...
    if (
      ...
      for (const key in queryValue) {
        if (Object.hasOwn(queryValue, key) && arrayComparisonFunctions[key]) {
          return matchQueryPart(obj, queryKey, queryValue, true);
        }
      }
    }
