...
- NEW! Generate ORM-like APIs in TypeScript, based on your schema or inferred from actual data.
...
- getTable/getRow/getCell 都是从 `tablesMap` 这个映射表中计算取值的
