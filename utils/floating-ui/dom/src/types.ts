import {
  ...
  type ComputePositionConfig as CoreComputePositionConfig,
  type DetectOverflowOptions as CoreDetectOverflowOptions,
  type Dimensions,
  type ElementRects,
  type FlipOptions,
  type HideOptions,
  type Middleware as CoreMiddleware,
  type MiddlewareReturn,
  type MiddlewareState as CoreMiddlewareState,
  type Padding,
  type Rect,
  type RootBoundary,
  type ShiftOptions,
  type SideObject,
  type SizeOptions as CoreSizeOptions,
  type Strategy,
...
export { autoUpdate, type Options as AutoUpdateOptions } from './autoUpdate';
